# A World Time And Date Using React.js + Vite

# Deployed Version
https://yehiaakarim.github.io/React-time/
...
# npm install 
# npm run dev 
Runs the app in the development mode. open ➜  Local:   http://localhost:5173/React-time
